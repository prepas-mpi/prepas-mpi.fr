...
Cet article date de **l'été 2026**.
{{< /admonition >}}

{{< admonition quote "Les dangers de l'IA en une phrase" true >}}
...
En TP, notamment d'informatique, c'est le moment où l'IA pourrait être la plus "utile" au lycée. Cependant c'est aussi à cette occasion qu'il est possible de prendre de mauvaises habitudes en l'utilisant :

{{< admonition quote "Utiliser l'IA en TP d'informatique" true >}}
...
Il est beaucoup plus tentant d'utiliser l'intelligence artificielle chez soi, et cela semble aussi plus justifié car, après tout, chez soi il n'y a personne pour nous aider, sauf peut-être d'autres élèves de la classe ou des personnes sur des forums.

{{< admonition quote "Continuer les TP d'informatique à la maison" true >}}
...
La création de contenu d'entraînement chez soi à l'aide de l'IA est très accessible, mais il faut surtout se demander : "est-ce que le contenu créé est adapté ?" ou "n'y avait-t-il pas déjà des ressources disponibles en ligne ?"
 
{{< admonition quote "Utiliser l'IA pour la correction / création de contenu" true >}}
Le risque est de remplacer la recherche par la consultation de corrigés.
...
Les LLMs n'ont pas connaissance du programme de prépa et tendent à répondre avec des éléments hors-programme ou inadaptées (ex : utiliser des [VLA](https://en.wikipedia.org/wiki/Variable-length_array) pour de la programmation C alors que cela est interdit). Leur utilisation est de fait contre-productive et est donc à éviter.
{{< /admonition >}}
...
{{< admonition quote "L'IA, ou le risque de tout déléguer" true >}}
...
{{< admonition quote "L'IA, ou l'impression d'apprendre" true >}}
...
Les modèles d'Intelligence Artificielle ont un [impact humain](https://muse.jhu.edu/article/950958), notamment car pour entraîner des LLM les grandes compagnies sous-payent des travailleurs dans des pays comme l'Inde.  
